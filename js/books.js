 ...
 *             그림 파일 books/<id>/<이름>.png 이 있으면 그것을 먼저 쓰고, 없으면 여기 것을 씁니다.
 *  pages    : 펼침면 하나가 객체 하나
...
window.BOOKS = [
  {
    ...
    art: {
      ...
      'dani':         { src: 'dani.png' },
      'dani-red':     { src: 'dani.png', badge: '👑', tint: '#ff5252' },
      'dani-blue':    { src: 'dani.png', badge: '👑', tint: '#4f8dff' },
      'dani-pink':    { src: 'dani.png', badge: '👑', tint: '#ff7eb6' },
      'dani-fly':     { src: 'dani.png', badge: '👑' },
      'dragon-big':   { emoji: '🐉' },
      'dragon-nice':  { emoji: '🐲' },
      'giant-big':    { emoji: '🧌' },
