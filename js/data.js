 ...
 *  wordKo  : (없어도 됩니다) true 면 '글자 찾기'·'짝 맞추기' 에서 영어 대신 우리말(ko) 글자를
 *            보여 주고 우리말로 읽어 줍니다. 국기처럼 '그림을 보고 우리말 이름을 읽는' 연습에 씁니다.
 *            '듣고 찾기' 는 그대로 lang 의 언어를 씁니다 — 영어를 듣고 찾는 연습은 남겨 둡니다.
...
window.LESSONS = [
...

  {
    ...
    icon: '🚩',
    lang: 'en-US',
    wordKo: true,            // 글자 찾기·짝 맞추기는 우리말 이름으로 (듣고 찾기는 영어 그대로)
    items: [
      /* 아시아 47 */
